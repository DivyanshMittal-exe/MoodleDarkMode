...
//buttons
var panels = document.querySelectorAll("[role='button']");
for(var i = 0; i<panels.length;i++){
    panels[i].style.backgroundImage= "url('https://i.imgur.com/esqBbr2.jpeg')";
    panels[i].style.color = "#c9d1d9";
    panels[i].style.textShadow = "none";
